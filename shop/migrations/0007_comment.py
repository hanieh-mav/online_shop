    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='romment', to='shop.comment')),
